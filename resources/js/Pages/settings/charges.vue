        ...
        <div class="py-4">
            <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class=" space-x-4 sm:-my-px sm:ms-4 sm:flex">
                    <NavLink :href="route('settings.company_details')"
                        :active="route().current('settings.company_details')">
                        Details
                    </NavLink>
            ...
            <form @submit.prevent="submitForm">
                ...
                <div class="mb-4 grid grid-cols-3 gap-4">
                    <div>
                        ...
                        <input v-model="form.zone_id" type="text" id="zone_id"
                    ...
                    <div>
                        ...
                        <input v-model="form.fs_per_km" type="number" id="fs_per_km"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" required />
                    </div>
                    <div>
                        <label for="gs_per_km" class="block text-sm font-medium text-gray-700">GS Per KM</label>
                        <input v-model="form.gs_per_km" type="number" id="gs_per_km"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" required />
                    </div>
                </div>
                ...
                <div class="mb-4 grid grid-cols-3 gap-4">
                    <div>
                        ...
                        <input v-model="form.p_per_km" type="number" id="p_per_km"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" required />
                    </div>
                    <div>
                        <label for="r_per_km" class="block text-sm font-medium text-gray-700">R Per KM</label>
                        <input v-model="form.r_per_km" type="number" id="r_per_km"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" required />
                    </div>
                    <div>
                        <label for="free_delivery_on" class="block text-sm font-medium text-gray-700">Free Delivery
                            On</label>
                        <input v-model="form.free_delivery_on" type="number" id="free_delivery_on"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" required />
                    </div>
                ...
                <div class="mb-4 grid grid-cols-3 gap-4">
                    <div>
                        ...
                        <input v-model="form.r_per_person" type="number" id="r_per_person"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" required />
                    </div>
                    <div>
                        <label for="p_per_weight" class="block text-sm font-medium text-gray-700">P Per Weight</label>
                        <input v-model="form.p_per_weight" type="number" id="p_per_weight"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" required />
                    </div>
                    <div>
                        <label for="p_weight" class="block text-sm font-medium text-gray-700">P Weight</label>
                        <input v-model="form.p_weight" type="number" id="p_weight"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" required />
                    </div>
                </div>
                ...
                <div class="mb-4 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input v-model="form.tax_per" type="number" id="tax_per"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" required />
                    </div>
                </div>
