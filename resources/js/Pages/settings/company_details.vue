            ...
            <div class="grid grid-cols-1 gap-4 mb-4">
              ...
              <div class="grid grid-cols-2 gap-4 mb-4">
                ...
                <div class="card flex justify-center">
                  <FileUpload mode="basic" name="company_logo_square" accept="image/*" :maxFileSize="1000000"
                    :auto="false" chooseLabel="Upload Square Logo"
                    @select="(event) => onFileSelect('company_logo_square', event)" />
                </div>
                <div>
                  <label class="block text-sm font-medium mb-1">Rectangular Logo</label>
                  <img v-if="company.company_logo_rectangular" :src="'storage/' + company.company_logo_rectangular"
                    alt="Company Banner" class="w-100 h-32 object-cover" />
                </div>
                <div class="card flex justify-center">
                  <FileUpload mode="basic" name="company_logo_rectangular" accept="image/*" :maxFileSize="1000000"
                    :auto="false" chooseLabel="Upload Rectangular Logo"
